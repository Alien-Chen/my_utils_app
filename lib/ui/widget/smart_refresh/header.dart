...
/// 经典Header
class MyEasyHeader extends Header {
  /// Key
  final Key key;
...
/// 经典Header组件
class MyEasyHeaderWidget extends StatefulWidget {
  final MyEasyHeader classicalHeader;
  ...
  @override
  MyEasyHeaderWidgetState createState() => MyEasyHeaderWidgetState();
}

class MyEasyHeaderWidgetState extends State<MyEasyHeaderWidget>
    with TickerProviderStateMixin<MyEasyHeaderWidget> {
  // 是否到达触发刷新距离
